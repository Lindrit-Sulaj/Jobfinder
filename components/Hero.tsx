...
export default function Hero() {
  return (
    <section className="Hero bg-customBlue-800 pt-6 pb-14 text-white px-6 md:px-8">
      <div className="max-w-screen-xl mx-auto">
        <h1 className='font-bold text-center text-3xl'>Find your dream job in Kosovo</h1>
...
function Search() {
  return (
    <div className='flex justify-center gap-3 mt-6'>
      <div className='flex bg-customBlue-700 gap-3 items-center rounded-lg py-3 px-4'>
      ...
      <Button className='bg-customBlue-500 px-5 rounded-lg hover:bg-customBlue-400 transition-all'>Search</Button>
    </div>
  )
}