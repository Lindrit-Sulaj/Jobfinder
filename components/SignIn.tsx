  ...
  return (
    <form className='mt-6' onSubmit={(e) => handleSubmit(e)}>
      ...
      <Button type="button" className='py-2 flex justify-center items-center gap-4 font-medium rounded-sm my-[10px] border-solid border-[1px] border-neutral-200 w-full'>
        <img className='w-6 h-6' src="https://www.freepnglogos.com/uploads/google-logo-png/google-logo-icon-png-transparent-background-osteopathy-16.png" alt="Google Logo" />
